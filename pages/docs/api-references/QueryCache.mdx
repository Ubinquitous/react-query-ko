...
`QueryCache`가 내부적으로 어떻게 작동하는지 더 잘 이해하려면 [#18: Inside React Query](../../framework/react/community-resources/tkdodos-blog#18-inside-react-query)에서 커뮤니티 리소스를 참고하세요.
