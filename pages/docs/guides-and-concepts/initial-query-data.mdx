...
- 명령적으로:
  - [쿼리 데이터를 미리 가져오기 위해 `queryClient.prefetchQuery` 사용](../../../react/guides/prefetching)
  - [쿼리 데이터를 수동으로 캐시에 넣기 위해 `queryClient.setQueryData` 사용](../../../react/guides/prefetching)
...
`Initial Data`와 `Placeholder Data`의 비교에 대해 알아보려면 [커뮤니티 자료](../../community-resources/tkdodos-blog#9-placeholder-and-initial-data-in-react-query)를 참조하세요.
