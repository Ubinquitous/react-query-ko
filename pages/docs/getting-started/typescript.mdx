...
타입 추론에 대한 팁과 요령은 커뮤니티 리소스의 [React Query와 TypeScript](/docs/community-resources/tkdodos-blog)를 참조하세요. 최상의 타입 안전성을 확보하는 방법을 알고 싶다면, [Type-safe React Query](/docs/community-resources/tkdodo-s-blog)를 읽어보세요.
