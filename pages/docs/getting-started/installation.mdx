...
{/* prettier-ignore */}
><b><i>"도입하기 전에 사용해보고 싶으신가요? 간단하고 기본적인 예제를<br/>체험해보세요!"</i></b>
...
{/* prettier-ignore */}
> <b><i>"위처럼 JSX 없이도 React를 사용할 수 있습니다."</i></b>
...
{/* prettier-ignore */}
> <b><i>"환경에 따라 폴리필(polyfill)을 추가해야 할 수도 있습니다. <br />구형 브라우저를 지원하려면 node_modules에서 라이브러리를 직접 트랜스파일(transpile)해야<br/>합니다."</i></b>
