...
더 큰 애플리케이션에서 Query Keys를 정리하는 방법에 대한 팁은 [Effective React Query Keys](../../community/tkdodos-blog#8-effective-react-query-keys)를 확인하고, Community Resources에서 [Query Key Factory Package](../../community/community-projects#query-key-factory)를 살펴보세요.
