...
이를 구현하기 위해서는, 애플리케이션을 `ReactQueryStreamedHydration` 컴포넌트로 래핑하면 됩니다:
...
자세한 정보는 [NextJs Suspense 스트리밍 예제](../../examples/nextjs-suspense-streaming) 및 [고급 렌더링 및 Hydration](../advanced-ssr) 가이드를 참조하세요.
